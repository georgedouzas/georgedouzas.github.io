...
As an example, let's assume that we would like to create a data workflow that downloads,
stores and updates historical and fixtures soccer data from [Football-Data.co.uk](https://www.football-data.co.uk). The URL of
each of those main leagues has the following form: 
